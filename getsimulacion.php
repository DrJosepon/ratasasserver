...
$nombreope = $_GET['nombreope'];
$descripcionpro = $_GET['descripcionpro'];
$descripcioncon = $_GET['descripcioncon'];
$cantidad = $_GET['cantidad'];
$format = $_GET['format'];
//$sql = "  select * from region";

$sql = "exec USP_SIMULADOR '$nombrereg', '$nombreope', '$descripcionpro', '$descripcioncon', '$cantidad'";
